...
* Send the _absolute_ path of the file as plain text payload to UDP port `3430` of the computer the code is running on
...
`<UTC unix time in millisconds>,<the payload of the packet directly as you sent it><0x0A>`
